...
const VendorAuth: React.FC = () => {
  ...
  const handleGoogleSignIn = async () => {
    console.log('VendorAuth: Initiating Google Sign-In...');
    try {
      setError("");
      await authService.signInWithGoogle({ userType: 'vendor' });
      console.log('VendorAuth: Google Sign-In initiated.');
    } catch (err: any) {
      console.error('VendorAuth: Google Sign-In failed', err);
      setError(err.message);
